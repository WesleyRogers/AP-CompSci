...
public class GameBooth {
    ...
    private int firstPrizesWon, consolationPrizesWon;
    /**
    * constructor
    * pre: none
    ...
    */
    ...
    public String prizesAwarded(){
        return "there have been " + this.firstPrizesWon + " first prizes won and " + this.consolationPrizesWon + " consolation prizes won.";
    }
}