...
/*
    Program 481a Bubble Sort
    Wesley Rogers 
    3/4/16
    Java 1.8u25, using Eclipse Mars
    Windows 7
    
    Sorts numbers from numsort.dat
    
    What I learned: I learned how bubblesort works! The doc wasn't super helpful, although I was able to find a great grpahic on how it works on the wikipedia page.
    
    Difficulties: None. Funnily enough though, my first attempt sorted the array backwards. Whoops!
*/
...
public class BubbleSort {
    ...
    public static void main(String[] args) {
        ...
        int[] nums = toIntArray(list); //Sadly, there literally is no better way than this. Dangit java!
        bubbleSort(nums);
