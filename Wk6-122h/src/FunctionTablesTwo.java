...
public class FunctionTablesTwo {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <21; i++){
            ...
            System.out.println( limitStringSize(number+"",8)+ "      " + limitStringSize(square+"",8) + "        " + limitStringSize(rootNum+"",6) + "   " + limitStringSize(cube+"",8) + "      " + limitStringSize(fourRoot+"",6));
        }
    }
...
/*Sample Output !!!Leading spaces were not copied for some reason.!!!
Numbers       Squares  Square Roots      Cubes   4th Roots
1             1           1.0          1         1.0
2             4        1.4142          8      1.1892
3             9        1.7320         27      1.3160
4            16           2.0         64      1.4142
5            25        2.2360        125      1.4953
6            36        2.4494        216      1.5650
7            49        2.6457        343      1.6265
8            64        2.8284        512      1.6817
9            81           3.0        729      1.7320
10           100        3.1622       1000      1.7782
11           121        3.3166       1331      1.8211
12           144        3.4641       1728      1.8612
13           169        3.6055       2197      1.8988
14           196        3.7416       2744      1.9343
15           225        3.8729       3375      1.9679
16           256           4.0       4096         2.0
17           289        4.1231       4913      2.0305
18           324        4.2426       5832      2.0597
19           361        4.3588       6859      2.0877
